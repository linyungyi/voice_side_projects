...
typedef struct tag_MEDIA_GATEWAY_CONFIG
{
    ...
    GW_EP                   VidRtpEp;      // Video Endpoint MPEG4/H263/H263+ (depends upon configuration)
    GW_EP                   AudRtpEp;      // Audio Bypass Channel AMR/G.723 (depends upon configuration)
    GW_CHAN                 VidChan;       // Video Channel MPEG4/H263/H263+ (depends upon configuration)
    GW_CHAN                 AudByChan;     // AMR Bypass Channel AMR/G.723 (depends upon configuration)
    ...
    BOOL                    video_path_initialized;
    BOOL                    audio_path_initialized;    
...
extern void *CommandLoop( void *param );
